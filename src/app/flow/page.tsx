      ...
      <main className="max-w-6xl mx-auto px-4 py-8 space-y-8">
        ...
        <section className="bg-white rounded-xl border p-6">
          ...
          <div className="grid gap-4 md:grid-cols-3">
            ...
            <a href="https://github.com" target="_blank" rel="noopener noreferrer" className="flex items-center gap-3 p-4 rounded-lg border hover:bg-gray-50 transition-colors">
